#ifndef ROAD_DATA_TO_GEOJSON_CONVERTER_HPP
#define ROAD_DATA_TO_GEOJSON_CONVERTER_HPP
...
class RoadDataToGeoJsonConverter {
public:
    RoadDataToGeoJsonConverter() = default;
    ~RoadDataToGeoJsonConverter() = default;
...
#endif // ROAD_DATA_TO_GEOJSON_CONVERTER_HPP